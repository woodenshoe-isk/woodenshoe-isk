...
if diagnostic_dict.get("safe_booktitle"):
    print(
        (
            "Titles whose booktitle doesn't display safely are: ",
            diagnostic_dict["safe_booktitle"],
        )
    )
if diagnostic_dict.get("authors_as_string"):
    print(
        (
            "Titles whose authors don't display safely as string are: ",
            diagnostic_dict["authors_as_string"],
        )
    )
...
if diagnostic_dict.get("distributors_as_string"):
    print(
        (
            "Titles without distributors as string are: ",
            diagnostic_dict["distributors_as_string"],
        )
    )
