...
def updateItem(
    t, updateTitle=False, updateImage=False, updateAuthors=False, updateCategories=False
):
    try:
        ...
        if updateImage:
            ...
            Images(
                titleID=t.id,
                largeUrl=amazon_info.LargeImage.URL,
                medUrl=amazon_info.MediumImage.URL,
                smallUrl=amazon_info.SmallImage.URL,
            )
