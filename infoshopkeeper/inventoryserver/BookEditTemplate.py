...
__CHEETAH_genTime__ = 1316642131.86445
...
class BookEditTemplate(Skeleton):
    ...
    def pagetitle(self, **KWS):
        ...
        write(u'''Editing a copy of ''')
        _v = VFFSL(SL,"book.title.booktitle",True) # u'${book.title.booktitle}' on line 5, col 19
        if _v is not None: write(_filter(_v, rawExpr=u'${book.title.booktitle}')) # from line 5, col 19.
        write(u'''
''')
    ...
    def body(self, **KWS):
        ...
        write(u'''<h1>''')
        _v = VFFSL(SL,"book.title.booktitle",True) # u'$book.title.booktitle' on line 9, col 5
        if _v is not None: write(_filter(_v, rawExpr=u'$book.title.booktitle')) # from line 9, col 5.
        write(u'''</h1>
<form method="get" action="/bookedit">
''')
        _v = VFFSL(SL,"book.object_to_form",True) # u'$book.object_to_form' on line 11, col 1
        if _v is not None: write(_filter(_v, rawExpr=u'$book.object_to_form')) # from line 11, col 1.
        write(u'''
</form>
''')
