...
class TitleEditTemplate(EditTemplate):
    ...
    def headscripts(self, **KWS):
        ...
        _v = VFN(VFFSL(SL,"EditTemplate",True),"headscripts",False)(VFFSL(SL,"self",True)) # '$EditTemplate.headscripts($self)' on line 11, col 1
        if _v is not None: write(_filter(_v, rawExpr='$EditTemplate.headscripts($self)')) # from line 11, col 1.
        write('''
...
''')
    ...
    def pagetitle(self, **KWS):
        ...
        write('''Editing ''')
        _v = VFFSL(SL,"title.booktitle",True) # '${title.booktitle}' on line 35, col 9
        if _v is not None: write(_filter(_v, rawExpr='${title.booktitle}')) # from line 35, col 9.
        write('''
''')
...
''')
        ...
        if VFFSL(SL,"should_show_images",True): # generated from line 42, col 1
            if VFFSL(SL,"title.images",True): # generated from line 43, col 1
                ...
                _v = VFN(VFFSL(SL,"title.images",True),"retrieve_image_url",False)('large') # "$title.images.retrieve_image_url('large')" on line 44, col 32
                if _v is not None: write(_filter(_v, rawExpr="$title.images.retrieve_image_url('large')")) # from line 44, col 32.
                write('''"><br></div>
''')
        write('''
...
''')
        _v = VFFSL(SL,"title.object_to_form",True) # '$title.object_to_form' on line 51, col 1
        if _v is not None: write(_filter(_v, rawExpr='$title.object_to_form')) # from line 51, col 1.
        write('''
</form>
...
''')
        for a in VFFSL(SL,"title.author",True): # generated from line 57, col 1
            ...
            if _v is not None: write(_filter(_v, rawExpr='$a.authorName')) # from line 58, col 12.
            write('''</span><a class="listinglink" href="/authoredit?id=''')
            _v = VFFSL(SL,"a.id",True) # '$a.id' on line 58, col 76
            if _v is not None: write(_filter(_v, rawExpr='$a.id')) # from line 58, col 76.
            write('''&title_id=''')
            _v = VFFSL(SL,"title.id",True) # '$title.id' on line 58, col 91
            if _v is not None: write(_filter(_v, rawExpr='$title.id')) # from line 58, col 91.
            write('''&new_author=False">edit</a><a class="listinglink" href="/titleedit?id=''')
            _v = VFFSL(SL,"title.id",True) # '$title.id' on line 58, col 170
            if _v is not None: write(_filter(_v, rawExpr='$title.id')) # from line 58, col 170.
            write('''&author_id=''')
            _v = VFFSL(SL,"a.id",True) # '$a.id' on line 58, col 190
            if _v is not None: write(_filter(_v, rawExpr='$a.id')) # from line 58, col 190.
...
''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$title.id')) # from line 60, col 56.
...
<li><a class="listinglink" href="/bookedit?id=''')
            ...
            if _v is not None: write(_filter(_v, rawExpr='$b.id')) # from line 72, col 47.
            write('''">edit</a></li>
<li><a class="listinglink print_link" href=\'/admin/print_label?booktitle=urllib.quote_plus(''')
            _v = VFFSL(SL,"b.title.booktitle",True) # '$b.title.booktitle' on line 73, col 92
            if _v is not None: write(_filter(_v, rawExpr='$b.title.booktitle')) # from line 73, col 92.
            write(''')&isbn=''')
            _v = VFFSL(SL,"b.title.isbn",True) # '$b.title.isbn' on line 73, col 117
            if _v is not None: write(_filter(_v, rawExpr='$b.title.isbn')) # from line 73, col 117.
            write('''&authorstring=urllib.quote_plus(''')
            _v = VFFSL(SL,"b.title.authors_as_string",True) # '$b.title.authors_as_string' on line 73, col 162
            if _v is not None: write(_filter(_v, rawExpr='$b.title.authors_as_string')) # from line 73, col 162.
            write(''')&ourprice=''')
            _v = VFFSL(SL,"b.ourprice",True) # '$b.ourprice' on line 73, col 199
            if _v is not None: write(_filter(_v, rawExpr='$b.ourprice')) # from line 73, col 199.
            write('''&listprice=''')
            _v = VFFSL(SL,"b.listprice",True) # '$b.listprice' on line 73, col 221
            if _v is not None: write(_filter(_v, rawExpr='$b.listprice')) # from line 73, col 221.
...
<b>copy from """)
            ...
            if _v is not None: write(_filter(_v, rawExpr='$b.distributor')) # from line 77, col 14.
            write(''' owned by ''')
            _v = VFFSL(SL,"b.owner",True) # '$b.owner' on line 77, col 38
            if _v is not None: write(_filter(_v, rawExpr='$b.owner')) # from line 77, col 38.
            write(''' <br />
inventoried on ''')
            _v = VFFSL(SL,"b.inventoried_when",True) # '$b.inventoried_when' on line 78, col 16
            if _v is not None: write(_filter(_v, rawExpr='$b.inventoried_when')) # from line 78, col 16.
            write(''' at $''')
            _v = VFFSL(SL,"b.ourprice",True) # '$b.ourprice' on line 78, col 41
            if _v is not None: write(_filter(_v, rawExpr='$b.ourprice')) # from line 78, col 41.
            write("""<br />
with status '""")
            _v = VFFSL(SL,"b.status",True) # '$b.status' on line 79, col 14
            if _v is not None: write(_filter(_v, rawExpr='$b.status')) # from line 79, col 14.
            write("""'
""")
            if VFFSL(SL,"b.status",True) != 'STOCK': # generated from line 80, col 1
                write(''' on ''')
                _v = VFFSL(SL,"b.sold_when",True) # '$b.sold_when' on line 81, col 5
                if _v is not None: write(_filter(_v, rawExpr='$b.sold_when')) # from line 81, col 5.
                write('''
''')
            write("""<br/>
in location '""")
            _v = VFFSL(SL,"b.location.locationName",True) # '$b.location.locationName' on line 84, col 14
            if _v is not None: write(_filter(_v, rawExpr='$b.location.locationName')) # from line 84, col 14.
            write("""'<br /></b>
</td>
""")
            # <td>
...
''')
        for c in VFFSL(SL,"title.categorys",True): # generated from line 100, col 1
            ...
            _v = VFFSL(SL,"c.categoryName",True) # '$c.categoryName' on line 101, col 44
            if _v is not None: write(_filter(_v, rawExpr='$c.categoryName')) # from line 101, col 44.
            write('''</span><a class="listinglink" href="/categoryedit?id=''')
            _v = VFFSL(SL,"c.id",True) # '$c.id' on line 101, col 112
            if _v is not None: write(_filter(_v, rawExpr='$c.id')) # from line 101, col 112.
            write('''">edit</a></div>
''')
        write('''
