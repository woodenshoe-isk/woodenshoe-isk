...
class Test_Noteboard(unittest.TestCase):
    ...
    def test_noteboard_class_instantiates(self):
        self.assertIsInstance(
            self._my_class, Noteboard, "Could not instantiate Noteboard"
        )

    def test_noteboard_returns_page(self):
        code, error = tidylib.tidy_document(
            self._my_class.noteboard(), options={"show-errors": 1, "show-warnings": 0}
        )
    ...
    def test_get_notes(self):
        ...
        self.assertIsInstance(
            result, type([]), "/notes/get_notes does not return array"
        )

    def test_post_note(self):
        code, error = tidylib.tidy_document(
            self._my_class.post_note(**{"author": "test", "message": "test"}),
            options={"show-errors": 1, "show-warnings": 0},
        )
...
class Test_Register(unittest.TestCase):
    ...
    def test_register_class_instantiates(self):
        self.assertIsInstance(
            self._my_class, Register, "Register class did not instiate"
        )

    @unittest.expectedFailure
    def test_build_cart_unit(self):
        code, error = tidylib.tidy_document(
            self._my_class.build_cart(), options={"show-errors": 1, "show-warnings": 0}
        )
    ...
    def test_build_cart_functional(self):
        ...
        code, error = tidylib.tidy_document(
            response.body, options={"show-errors": 1, "show-warnings": 0}
        )
    ...
    def test_add_item_to_cart_functional(self):
        ...
        result = self._my_app.post(
            "/register/add_item_to_cart", {"item": json.dumps(item)}
        )
        ...
        self.assertEqual(
            item, confirm, "/register/add_item_to_cart returned error in function test"
        )
    ...
    def test_select_item_search(self):
        random_item = random.sample(list(Book.selectBy(status="STOCK")), 1)[0]
        code, error = tidylib.tidy_document(
            self._my_class.select_item_search(title=random_item.title.booktitle),
            options={"show-errors": 1, "show-warnings": 0},
        )
        self.assertFalse(
            error, "/register/select_item_search does not return valid html page"
        )
    ...
    def test_get_item_by_isbn_in_stock(self):
        ...
        self.assertTrue(
            result, "/register/get_item_by_isbn does not return item when it should"
        )
...
class Test_Admin(unittest.TestCase):
    ...
    def test_admin_class_instantiates(self):
        self.assertIsInstance(
            self._my_class, Admin, "Admin class did not instantiate properly"
        )

    def test_kindedit_unit(self):
        code, error = tidylib.tidy_document(
            self._my_class.kindedit(), options={"show-errors": 1, "show-warnings": 0}
        )
    ...
    def test_kindlist_unit(self):
        code, error = tidylib.tidy_document(
            self._my_class.kindlist(), options={"show-errors": 1, "show-warnings": 0}
        )
    ...
    def test_add_to_inventory_unit(self):
        ...
        self.assertFalse(
            error, "method Admin.add_to_inventory does not return valid html page"
        )
    ...
    def test_add_item_to_inventory_that_we_have_already_returns_object(self):
        ...
        self.assertTrue(
            confirm, "test_add_item_to_inventory does not add item to inventory"
        )
    ...
    def test_search_isbn_that_we_have_functional(self):
        random_item = random.sample(list(Title.select()), 1)[0]
        response = self._my_app.get(
            "/admin/search_isbn", {"isbn": random_item.isbn}
        ).json[0]
        self.assertEqual(
            response["isbn"],
            random_item.isbn,
    ...
    def test_print_label_unit(self):
        random_item = random.sample(
            list(Title.select('WHERE title.isbn RLIKE "^978"')), 1
        )[0]
    ...
    def test_select_item_for_isbn_search_functional(self):
        random_item = random.sample(list(Title.select()), 1)[0]
        response = self._my_app.get(
            "/admin/select_item_for_isbn_search", {"isbn": random_item.isbn}
        )
        code, error = tidylib.tidy_document(
            response.body, options={"show-errors": 1, "show-warnings": 0}
        )
        self.assertFalse(
            error, "/admin/select_item_for_isbn_search did not return proper response"
        )
...
class Test_InventoryServer(unittest.TestCase):
    ...
    def test_index_unit(self):
        code, error = tidylib.tidy_document(
            self._my_class.index(), options={"show-errors": 1, "show-warnings": 0}
        )
        self.assertFalse(
            error, "method InventoryServer.index does not return valid html page"
        )
    ...
    def test_bookedit_unit(self):
        code, error = tidylib.tidy_document(
            self._my_class.bookedit(), options={"show-errors": 1, "show-warnings": 0}
        )
        self.assertFalse(
            error, "method InventoryServer.bookedit does not return valid html page"
        )
    ...
    def test_categoryedit_unit(self):
        ...
        self.assertFalse(
            error, "method InventoryServer.categoryedit does not return valid html page"
        )
    ...
    def test_authoredit_unit(self):
        code, error = tidylib.tidy_document(
            self._my_class.authoredit(), options={"show-errors": 1, "show-warnings": 0}
        )
        self.assertFalse(
            error, "method InventoryServer.authoredit does not return valid html page"
        )
    ...
    def test_titleedit_unit(self):
        code, error = tidylib.tidy_document(
            self._my_class.titleedit(), options={"show-errors": 1, "show-warnings": 0}
        )
        self.assertFalse(
            error, "method InventoryServer.titleedit does not return valid html page"
        )
    ...
    def test_titlelist_unit(self):
        code, error = tidylib.tidy_document(
            self._my_class.titlelist(), options={"show-errors": 1, "show-warnings": 0}
        )
        self.assertFalse(
            error, "method InventoryServer.titlelist does not return valid html page"
        )
    ...
    def test_search_unit(self):
        code, error = tidylib.tidy_document(
            self._my_class.search(), options={"show-errors": 1, "show-warnings": 0}
        )
        self.assertFalse(
            error, "method InventoryServer.search does not return valid html page"
        )
