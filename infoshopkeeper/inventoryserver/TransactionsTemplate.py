...
''')
    ...
    def body(self, **KWS):
        ...
        write(u'''<h1>Transactions</h1>
<form action="/transactions" method="post">
<label class=\'textbox\' for=\'what\'>What</label> <input type=\'text\' class=\'textbox\' name=\'what\' id=\'what\' value=\'''')
        _v = VFFSL(SL,"what",True) # u'${what}' on line 11, col 112
        if _v is not None: write(_filter(_v, rawExpr=u'${what}')) # from line 11, col 112.
        write(u"""'/> 
<label class='textbox' for='action'>Action</label> <input type='text' class='textbox' name='action' id='action' value='""")
        _v = VFFSL(SL,"action",True) # u'${action}' on line 12, col 120
        if _v is not None: write(_filter(_v, rawExpr=u'${action}')) # from line 12, col 120.
        write(u"""'/> 
<label class='textbox' for='begin_date'>Begin Date</label><input type='text' class='textbox' name='begin_date' id='begin_date' value='""")
        _v = VFFSL(SL,"begin_date",True) # u'${begin_date}' on line 13, col 135
        if _v is not None: write(_filter(_v, rawExpr=u'${begin_date}')) # from line 13, col 135.
        write(u"""'/>
<label class='textbox' for='end_date'>End Date</label><input type='text' class='textbox' name='end_date' id='end_date' value='""")
        _v = VFFSL(SL,"end_date",True) # u'${end_date}' on line 14, col 127
        if _v is not None: write(_filter(_v, rawExpr=u'${end_date}')) # from line 14, col 127.
        write(u'''\'/>
...
''')
        for t in VFFSL(SL,"transactions",True): # generated from line 32, col 1
            write(u'''<tr>
<td>''')
            _v = VFFSL(SL,"t.date",True) # u'${t.date}' on line 34, col 5
            if _v is not None: write(_filter(_v, rawExpr=u'${t.date}')) # from line 34, col 5.
            write(u'''</td>
<td>''')
            _v = VFFSL(SL,"t.action",True) # u'${t.action}' on line 35, col 5
            if _v is not None: write(_filter(_v, rawExpr=u'${t.action}')) # from line 35, col 5.
            write(u'''</td>
<td>''')
            _v = VFN(VFFSL(SL,"t",True),"get_info",False)() # u'${t.get_info()}' on line 36, col 5
            if _v is not None: write(_filter(_v, rawExpr=u'${t.get_info()}')) # from line 36, col 5.
            write(u'''</td>
<td>''')
            _v = VFFSL(SL,"t.amount",True) # u'${t.amount}' on line 37, col 5
            if _v is not None: write(_filter(_v, rawExpr=u'${t.amount}')) # from line 37, col 5.
            write(u'''</td>
<td><input type="image" name="deleteid" value="''')
            _v = VFFSL(SL,"t.id",True) # u'$t.id' on line 38, col 48
            if _v is not None: write(_filter(_v, rawExpr=u'$t.id')) # from line 38, col 48.
            write(u'''" src="delete.png"/></td>
</tr>
''')
        write(u'''</tbody>
</table>
