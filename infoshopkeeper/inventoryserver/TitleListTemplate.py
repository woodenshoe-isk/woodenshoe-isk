...
__CHEETAH_genTime__ = 1316642131.938507
...
class TitleListTemplate(Template):
    ...
    def respond(self, trans=None):
        ...
        for t in VFFSL(SL,"titles",True): # generated from line 1, col 1
            _v = VFFSL(SL,"t.booktitle",True) # u'$t.booktitle' on line 2, col 1
            if _v is not None: write(_filter(_v, rawExpr=u'$t.booktitle')) # from line 2, col 1.
            write(u'''|''')
            _v = VFFSL(SL,"t.isbn",True) # u'$t.isbn' on line 2, col 14
            if _v is not None: write(_filter(_v, rawExpr=u'$t.isbn')) # from line 2, col 14.
            write(u'''|''')
            _v = VFFSL(SL,"t.highest_price_book.listprice",True) # u'$t.highest_price_book.listprice' on line 2, col 22
            if _v is not None: write(_filter(_v, rawExpr=u'$t.highest_price_book.listprice')) # from line 2, col 22.
            write(u'''<br />
