...
class TitleListTemplate(Template):
    ...
    def respond(self, trans=None):
        ...
        for t in VFFSL(SL,"titles",True): # generated from line 2, col 1
            ...
            if _v is not None: write(_filter(_v, rawExpr='$t.booktitle')) # from line 3, col 1.
            write('''|''')
            _v = VFFSL(SL,"t.isbn",True) # '$t.isbn' on line 3, col 14
            if _v is not None: write(_filter(_v, rawExpr='$t.isbn')) # from line 3, col 14.
            write('''|''')
            _v = VFFSL(SL,"t.highest_price_book.listprice",True) # '$t.highest_price_book.listprice' on line 3, col 22
            if _v is not None: write(_filter(_v, rawExpr='$t.highest_price_book.listprice')) # from line 3, col 22.
            write('''<br />
