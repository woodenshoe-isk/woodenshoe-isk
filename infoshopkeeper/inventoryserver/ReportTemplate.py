...
__CHEETAH_genTime__ = 1307470722.741713
__CHEETAH_genTimestamp__ = 'Tue Jun  7 14:18:42 2011'
__CHEETAH_src__ = 'ReportTemplate.html'
__CHEETAH_srcLastModified__ = 'Fri Sep  3 18:34:02 2010'
...
''')
        if VFFSL(SL,"do_query",True): # generated from line 12, col 1
            write('''<table class="sortable" id="unique_id" >
''')
            _v = VFFSL(SL,"header",True) # '$header' on line 14, col 1
            if _v is not None: write(_filter(_v, rawExpr='$header')) # from line 14, col 1.
            write('''
''')
            for r in VFFSL(SL,"results",True): # generated from line 15, col 1
                _v = VFFSL(SL,"r",True) # '$r' on line 16, col 1
                if _v is not None: write(_filter(_v, rawExpr='$r')) # from line 16, col 1.
                write('''
''')
            write('''</table>
<b>Total: ''')
            _v = VFFSL(SL,"total",True) # '$total' on line 19, col 11
            if _v is not None: write(_filter(_v, rawExpr='$total')) # from line 19, col 11.
            write('''</b>
''')
