...
"""
        ...
        _v = VFN(
            VFFSL(SL, "report", True), "headscripts", False
        )()  # '${report.headscripts()}' on line 26, col 1
        if _v is not None:
            write(
                _filter(_v, rawExpr="${report.headscripts()}")
            )  # from line 26, col 1.
        write(
            """
"""
    ...
    def pagetitle(self, **KWS):
        ...
        write("""Report: """)
        _v = VFN(VFFSL(SL, "report", True), "metadata", True)[
            "name"
        ]  # "${report.metadata['name']}" on line 30, col 9
        if _v is not None:
            write(
                _filter(_v, rawExpr="${report.metadata['name']}")
            )  # from line 30, col 9.
        write(
            """
"""
    ...
    def body(self, **KWS):
        ...
        _v = VFN(VFFSL(SL, "report", True), "metadata", True)[
            "name"
        ]  # "${report.metadata['name']}" on line 34, col 5
        if _v is not None:
            write(
                _filter(_v, rawExpr="${report.metadata['name']}")
            )  # from line 34, col 5.
...
"""
        ...
        _v = VFN(
            VFFSL(SL, "report", True), "queryForm", False
        )()  # '${report.queryForm()}' on line 35, col 1
        if _v is not None:
            write(_filter(_v, rawExpr="${report.queryForm()}"))  # from line 35, col 1.
        write(
            """
"""
        )
...
"""
            ...
            if _v is not None:
                write(_filter(_v, rawExpr="$header"))  # from line 39, col 1.
            write(
                """
</thead>
<tbody>
"""
            ...
            for r in VFFSL(SL, "results", True):  # generated from line 42, col 1
                ...
                if _v is not None:
                    write(_filter(_v, rawExpr="$r"))  # from line 43, col 1.
                write(
                    """
"""
                )
...
"""
            ...
            if VFFSL(SL, "report.do_total", True):  # generated from line 46, col 1
                ...
                if _v is not None:
                    write(_filter(_v, rawExpr="$total"))  # from line 47, col 22.
                write(
                    """</b></td></tfoot>
"""
                )
