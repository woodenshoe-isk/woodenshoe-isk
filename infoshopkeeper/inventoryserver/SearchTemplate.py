...
<input class="textbox" type="text" id="title" name="title" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$title')) # from line 87, col 67.
        write('''" /><br />
...
<input class="textbox" type="text" name="author" id="author" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$author')) # from line 90, col 69.
        write('''" /><br />
...
<input class="textbox" type="text" name="category" id="category" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$category')) # from line 93, col 73.
        write('''" /><br />
...
<input class="textbox" type="text" name="isbn" id="isbn" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$isbn')) # from line 96, col 65.
        write('''" /><br />
...
''')
        ...
        for loc in VFFSL(SL,"locations",True): # generated from line 106, col 1
            ...
            if _v is not None: write(_filter(_v, rawExpr='$i')) # from line 107, col 12.
            write(""" value='""")
            _v = VFFSL(SL,"loc.id",True) # '$loc.id' on line 107, col 22
            if _v is not None: write(_filter(_v, rawExpr='$loc.id')) # from line 107, col 22.
            write("""' 
""")
            if "%s" %(VFFSL(SL,"loc.id",True))==VFFSL(SL,"location",True): # generated from line 108, col 1
                write('''selected="true" 
''')
            write('''>''')
            _v = VFFSL(SL,"loc.locationName",True) # '$loc.locationName' on line 111, col 2
            if _v is not None: write(_filter(_v, rawExpr='$loc.locationName')) # from line 111, col 2.
            write('''</option>
''')
            i = VFFSL(SL,"i",True)+1
        write('''</select><br />
...
<input class="textbox" type="text" name="publisher" id="publisher" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$publisher')) # from line 117, col 75.
        write('''" /><br />
...
<input class="textbox" type="text" name="distributor" id="distributor" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$distributor')) # from line 120, col 79.
        write('''" /><br />
...
<input class="textbox" type="text" name="owner" id="owner" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$owner')) # from line 123, col 67.
        write('''" /><br />
...
<input class="textbox" type="text" name="stock_less_than" id="stock_less_than" value="''')
        _v = VFFSL(SL,"stock_less_than",True) # '$stock_less_than' on line 145, col 87
        if _v is not None: write(_filter(_v, rawExpr='$stock_less_than')) # from line 145, col 87.
        write('''" /><br />
...
<input class="textbox" type="text" name="stock_more_than" id="stock_more_than" value="''')
        _v = VFFSL(SL,"stock_more_than",True) # '$stock_more_than' on line 148, col 87
        if _v is not None: write(_filter(_v, rawExpr='$stock_more_than')) # from line 148, col 87.
        write('''" /><br />
...
<input class="textbox" type="text" name="sold_more_than" id="sold_more_than"  value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$sold_more_than')) # from line 151, col 86.
        write('''" /><br />
...
<input type=\'text\' class=\'textbox\' name=\'sold_begin_date\' id=\'sold_begin_date\' value="''')
        _v = VFFSL(SL,"sold_begin_date",True) # '${sold_begin_date}' on line 154, col 87
        if _v is not None: write(_filter(_v, rawExpr='${sold_begin_date}')) # from line 154, col 87.
        write('''"/><br />
...
<input type=\'text\' class=\'textbox\' name=\'sold_end_date\' id=\'sold_end_date\' value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${sold_end_date}')) # from line 157, col 83.
        write('''"/><br />
...
<input type=\'text\' class=\'textbox\' name=\'inv_begin_date\' id=\'inv_begin_date\' value="''')
        _v = VFFSL(SL,"inv_begin_date",True) # '${inv_begin_date}' on line 160, col 85
        if _v is not None: write(_filter(_v, rawExpr='${inv_begin_date}')) # from line 160, col 85.
        write('''"/><br />
...
<input type=\'text\' class=\'textbox\' name=\'inv_end_date\' id=\'inv_end_date\' value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${inv_end_date}')) # from line 163, col 81.
        write('''"/><br />
...
''')
        for f in VFFSL(SL,"formats",True): # generated from line 171, col 1
            ...
            if _v is not None: write(_filter(_v, rawExpr='$f')) # from line 172, col 16.
            write("""' 
""")
            # if $f==$formatType
            # selected="true" 
            ...
            if _v is not None: write(_filter(_v, rawExpr='$f')) # from line 176, col 2.
            write('''</option>
''')
        write('''</select><br />
</div>
...
''')
        for k in VFFSL(SL,"kinds",True): # generated from line 183, col 1
            ...
            if _v is not None: write(_filter(_v, rawExpr='$k.id')) # from line 184, col 16.
            write("""' 
""")
            if "%s" %(VFFSL(SL,"k.id",True))==VFFSL(SL,"kind",True): # generated from line 185, col 1
                write('''selected="true" 
''')
            write('''>''')
            _v = VFFSL(SL,"k.kindName",True) # '$k.kindName' on line 188, col 2
            if _v is not None: write(_filter(_v, rawExpr='$k.kindName')) # from line 188, col 2.
            write('''</option>
''')
        write('''</select><br />
...
''')
      ...
      <td>''')
                ...
                if _v is not None: write(_filter(_v, rawExpr='$t.id')) # from line 222, col 11.
                write(''' </td>
      <td><input type="checkbox" name="titles" value="''')
                _v = VFFSL(SL,"t.id",True) # '$t.id' on line 223, col 55
                if _v is not None: write(_filter(_v, rawExpr='$t.id')) # from line 223, col 55.
                write('''" onclick=\'if (event.stopPropagation){
...
''')
                if VFFSL(SL,"should_show_images",True): # generated from line 229, col 9
                    write('''        <td>
''')
                    if VFFSL(SL,"t.images",True): # generated from line 231, col 13
                        if VFN(VFFSL(SL,"t.images",True),"retrieve_image_url",False)("small"): # generated from line 232, col 17
                            write("""                    <img src='""")
                            _v = VFN(VFFSL(SL,"t.images",True),"retrieve_image_url",False)("small") # '$t.images.retrieve_image_url("small")' on line 233, col 31
                            if _v is not None: write(_filter(_v, rawExpr='$t.images.retrieve_image_url("small")')) # from line 233, col 31.
                            write("""'>
""")
                    write('''        </td>
''')
                write('''        <td>''')
                if VFN(VFFSL(SL,"t",True),"safe",False)('booktitle') : # generated from line 238, col 13
                ...
                write('''</td>
        <td>''')
                if VFN(VFFSL(SL,"t",True),"authors_as_string",False)() : # generated from line 239, col 13
        ...
        <td>''')
                ...
                write('''</td>
        <td>''')
                if VFN(VFFSL(SL,"t",True),"copies_in_status",False)("STOCK") : # generated from line 241, col 13
                ...
                write('''</td>
        <td>''')
                if VFN(VFFSL(SL,"t",True),"copies_in_status",False)("SOLD") : # generated from line 242, col 13
                ...
                write('''</td>
        <td>''')
                if VFN(VFFSL(SL,"t",True),"distributors_as_string",False)() : # generated from line 243, col 13
                ...
                write('''</td>
        <td>''')
                if VFN(VFFSL(SL,"t",True),"safe",False)('publisher') : # generated from line 244, col 13
                ...
                write('''</td>
        <td>''')
                if VFFSL(SL,"t.first_book_inventoried",True) : # generated from line 245, col 13
                ...
                write('''</td>
        <td>''')
                if VFFSL(SL,"t.last_book_inventoried",True) : # generated from line 246, col 13
                ...
                write('''</td>
        <td>''')
                if VFFSL(SL,"t.first_book_sold",True) : # generated from line 247, col 13
                ...
                write('''</td>
        <td>''')
                if VFFSL(SL,"t.last_book_sold",True) : # generated from line 248, col 13
