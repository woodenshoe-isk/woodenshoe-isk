...
class StaffingCalendarTemplate(Skeleton):
    ...
    def headscripts(self, **KWS):
        ...
        write("""<link rel='stylesheet' type='text/css' href='/javascript/fullcalendar-1.5.4/fullcalendar.css' />
...
if not hasattr(StaffingCalendarTemplate, '_initCheetahAttributes'):
    templateAPIClass = getattr(StaffingCalendarTemplate, '_CHEETAH_templateClass', Template)
