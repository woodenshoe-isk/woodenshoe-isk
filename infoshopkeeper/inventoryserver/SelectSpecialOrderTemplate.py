...
class SelectSpecialOrderTemplate(Skeleton):
    ...
    def pagetitle(self, **KWS):
        ...
        if _v is not None:
            write(_filter(_v, rawExpr="$authorOrTitle"))  # from line 7, col 32.
        write(
            """'
"""
        )
...
"""
    ...
    def body(self, **KWS):
        ...
        if _v is not None:
            write(_filter(_v, rawExpr="$authorOrTitle"))  # from line 61, col 29.
        write(
            """'</h1>
    <p id='special_order_id' hidden>"""
        ...
        if _v is not None:
            write(_filter(_v, rawExpr="$specialOrderID"))  # from line 62, col 37.
        write(
            """</p>
...
"""
        ...
        for r in VFN(
            VFFSL(SL, "resultset", True), "values", False
        )():  # generated from line 78, col 10
            write(
                """              <tr>
"""
            )
            try:  # generated from line 80, col 21
                ...
                if VFN(
                    VFN(VFFSL(SL, "r", True), "get", False)("known_title"), "id", True
                ):  # generated from line 89, col 29
                    _v = VFN(
                        VFN(VFFSL(SL, "r", True), "get", False)("known_title"),
                        "id",
                        True,
                    )
                    if _v is not None:
...
if not hasattr(SelectSpecialOrderTemplate, "_initCheetahAttributes"):
    templateAPIClass = getattr(
        SelectSpecialOrderTemplate, "_CHEETAH_templateClass", Template
    )
