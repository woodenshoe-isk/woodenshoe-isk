...
<input class="textbox" minlength=\'1\' type="text" id="isbn" name="isbn" value="'''
        ...
        if _v is not None:
            write(_filter(_v, rawExpr="$isbn"))  # from line 278, col 79.
        write(
            """" />
...
"""
        ...
        for i in [1, 2, 3, 4]:  # generated from line 288, col 1
            ...
            if _v is not None:
                write(_filter(_v, rawExpr="$i"))  # from line 289, col 20.
            write("""'>""")
            _v = VFFSL(SL, "i", True)  # '$i' on line 289, col 24
            if _v is not None:
                write(_filter(_v, rawExpr="$i"))  # from line 289, col 24.
            write(
                """</option>
"""
            )
...
<input class="textbox required" type="text" id="quantity", name="quantity", value="'''
        ...
        if _v is not None:
            write(_filter(_v, rawExpr="$quantity"))  # from line 294, col 84.
        write(
            '''"/><br />
...
<input class="textbox required" type="text" id="title" name="title" value="'''
        ...
        if _v is not None:
            write(_filter(_v, rawExpr="$title"))  # from line 297, col 76.
        write(
            '''" /><br />
...
<input class="textbox required" type="text" name="authors" id="authors" value="'''
        ...
        if _v is not None:
            write(_filter(_v, rawExpr="$authors"))  # from line 300, col 80.
        write(
            '''" /><br />
...
<input class="textbox required" type="text" name="listprice" id="listprice" value="'''
        ...
        if _v is not None:
            write(_filter(_v, rawExpr="$listprice"))  # from line 303, col 84.
        write(
            '''" /><br />
...
<input class="textbox" type="text" name="ourprice" id="ourprice" value="'''
        ...
        if _v is not None:
            write(_filter(_v, rawExpr="$ourprice"))  # from line 306, col 73.
        write(
            '''" /><br />
...
<input class="textbox required" type="text" name="publisher" id="publisher" value="'''
        ...
        if _v is not None:
            write(_filter(_v, rawExpr="$publisher"))  # from line 309, col 84.
        write(
            '''" /><br />
...
<input class="textbox required" type="text" name="categories" id="categories" value="'''
        ...
        if _v is not None:
            write(_filter(_v, rawExpr="$categories"))  # from line 312, col 86.
        write(
            """" /><br />
...
"""
        ...
        for d in VFFSL(SL, "distributors", True):  # generated from line 316, col 1
            ...
            if _v is not None:
                write(_filter(_v, rawExpr="$d"))  # from line 317, col 16.
            write(
                """'
"""
            )
            if "%s" % (VFFSL(SL, "d", True)) == VFFSL(
                SL, "distributor", True
            ):  # generated from line 318, col 1
                write(
                    """selected="true"
"""
                )
            ...
            if _v is not None:
                write(_filter(_v, rawExpr="$d"))  # from line 321, col 2.
            write(
                """</option>
"""
            )
...
"""
        ...
        for loc in VFFSL(SL, "locations", True):  # generated from line 329, col 1
            ...
            if _v is not None:
                write(_filter(_v, rawExpr="$loc.id"))  # from line 330, col 16.
            write(
                """'
"""
            )
...
"""
            ...
            )  # '$loc.locationName' on line 334, col 2
            if _v is not None:
                write(_filter(_v, rawExpr="$loc.locationName"))  # from line 334, col 2.
            write(
                """</option>
"""
            )
...
<input class="textbox" type="text" name="owner" id="owner" value="'''
        ...
        if _v is not None:
            write(_filter(_v, rawExpr="$owner"))  # from line 340, col 67.
        write(
            '''" /><br />
...
<input class="textbox" type="text" id="tag" name="tag" value="'''
        ...
        if _v is not None:
            write(_filter(_v, rawExpr="$tag"))  # from line 343, col 63.
        write(
            """" /><br />
...
"""
        ...
        for k in VFFSL(SL, "kinds", True):  # generated from line 347, col 1
            ...
            if _v is not None:
                write(_filter(_v, rawExpr="$k.kindName"))  # from line 348, col 16.
            write(
                """'
"""
            )
...
"""
            ...
            if _v is not None:
                write(_filter(_v, rawExpr="$k.kindName"))  # from line 352, col 2.
            write(
                """</option>
"""
            )
...
"""
        ...
        for f in VFFSL(SL, "formats", True):  # generated from line 358, col 1
            ...
            if _v is not None:
                write(_filter(_v, rawExpr="$f"))  # from line 359, col 16.
            write(
                """'
"""
            )
            if "%s" % (VFFSL(SL, "f", True)) == VFFSL(
                SL, "format", True
            ):  # generated from line 360, col 1
                write(
                    """selected="true"
"""
                )
            ...
            if _v is not None:
                write(_filter(_v, rawExpr="$f"))  # from line 363, col 2.
            write(
                """</option>
"""
            )
...
<input class='textbox' type='hidden' id='known_title' name='known_title' value='"""
        ...
        if _v is not None:
            write(_filter(_v, rawExpr="$known_title"))  # from line 367, col 81.
        write(
            """'/>
...
<input class='textbox' type='hidden' id='orig_isbn' name='orig_isbn' value='"""
        ...
        if _v is not None:
            write(_filter(_v, rawExpr="$orig_isbn"))  # from line 369, col 77.
        write(
            """'/>
<input class='textbox' type='hidden' id='large_url' name='large_url' value='"""
        ...
        if _v is not None:
            write(_filter(_v, rawExpr="$large_url"))  # from line 370, col 77.
        write(
            """'/>
<input class='textbox' type='hidden' id='med_url' name='med_url' value='"""
        ...
        if _v is not None:
            write(_filter(_v, rawExpr="$med_url"))  # from line 371, col 73.
        write(
            """'/>
<input class='textbox' type='hidden' id='small_url' name='small_url' value='"""
        ...
        if _v is not None:
            write(_filter(_v, rawExpr="$small_url"))  # from line 372, col 77.
        write(
            """\'/>
...
if not hasattr(AddToInventoryTemplate, "_initCheetahAttributes"):
    templateAPIClass = getattr(
        AddToInventoryTemplate, "_CHEETAH_templateClass", Template
    )
