...
''')
    ...
    def body(self, **KWS):
        ...
        write('''<button id=\'new_special_order\' class=\'new_special_order\'><h2>New Special Order</h2></button></br>
...
<input class="textbox" type="text" name="customer_name" id="customer_name" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$customer_name')) # from line 69, col 83.
        write('''" /><br />
...
<input class="textbox" type="text" name="customer_phone_number" id="customer_phone_number" value="''')
        _v = VFFSL(SL,"customer_phone_number",True) # '$customer_phone_number' on line 72, col 99
        if _v is not None: write(_filter(_v, rawExpr='$customer_phone_number')) # from line 72, col 99.
        write('''" /><br />
...
<input class="textbox" type="text" name="customer_email" id="customer_email" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$customer_email')) # from line 75, col 85.
        write('''" /><br />
...
<input class="textbox" type="text" id="title" name="title" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$title')) # from line 78, col 67.
        write('''" /><br />
...
<input class="textbox" type="text" name="author" id="author" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$author')) # from line 81, col 69.
        write('''" /><br />
...
''')
        for k in VFFSL(SL,"kinds",True): # generated from line 85, col 1
            ...
            if _v is not None: write(_filter(_v, rawExpr='$k.id')) # from line 86, col 16.
            write("""' 
""")
            if "%s" %(VFFSL(SL,"k.id",True))==VFFSL(SL,"kind",True): # generated from line 87, col 1
                write('''selected="true" 
''')
            write('''>''')
            _v = VFFSL(SL,"k.kindName",True) # '$k.kindName' on line 90, col 2
            if _v is not None: write(_filter(_v, rawExpr='$k.kindName')) # from line 90, col 2.
            write('''</option>
''')
        write('''</select><br />
...
''')
        ...
        <td>''')
            ...
            write('''</td>
        <td>''')
            if VFFSL(SL,"s.customerPhoneNumber",True) : # generated from line 117, col 13
...
''')
            for t in VFFSL(SL,"s.titles",True): # generated from line 121, col 17
                ...
                write('''</li>
                            <li>''')
                if VFFSL(SL,"t.authors_as_string",True) : # generated from line 126, col 33
...
if not hasattr(SpecialOrderListTemplate, '_initCheetahAttributes'):
    templateAPIClass = getattr(SpecialOrderListTemplate, '_CHEETAH_templateClass', Template)
