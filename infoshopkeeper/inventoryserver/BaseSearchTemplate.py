...
<input class="textbox" type="text" id="title" name="title" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$title')) # from line 70, col 67.
        write('''" /><br />
...
<input class="textbox" type="text" name="author" id="author" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$author')) # from line 73, col 69.
        write('''" /><br />
...
<input class="textbox" type="text" name="category" id="category" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$category')) # from line 76, col 73.
        write('''" /><br />
...
<input class="textbox" type="text" name="isbn" id="isbn" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$isbn')) # from line 79, col 65.
        write('''" /><br />
...
''')
        ...
        for loc in VFFSL(SL,"locations",True): # generated from line 89, col 1
            ...
            if _v is not None: write(_filter(_v, rawExpr='$i')) # from line 90, col 12.
            write(""" value='""")
            _v = VFFSL(SL,"loc.id",True) # '$loc.id' on line 90, col 22
            if _v is not None: write(_filter(_v, rawExpr='$loc.id')) # from line 90, col 22.
            write("""' 
""")
            if "%s" %(VFFSL(SL,"loc.id",True))==VFFSL(SL,"location",True): # generated from line 91, col 1
                write('''selected="true" 
''')
            write('''>''')
            _v = VFFSL(SL,"loc.locationName",True) # '$loc.locationName' on line 94, col 2
            if _v is not None: write(_filter(_v, rawExpr='$loc.locationName')) # from line 94, col 2.
            write('''</option>
''')
            i = VFFSL(SL,"i",True)+1
        write('''</select><br />
...
<input class="textbox" type="text" name="publisher" id="publisher" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$publisher')) # from line 100, col 75.
        write('''" /><br />
...
<input class="textbox" type="text" name="distributor" id="distributor" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$distributor')) # from line 103, col 79.
        write('''" /><br />
...
<input class="textbox" type="text" name="owner" id="owner" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$owner')) # from line 106, col 67.
        write('''" /><br />
...
<input class="textbox" type="text" name="stock_less_than" id="stock_less_than" value="''')
        _v = VFFSL(SL,"stock_less_than",True) # '$stock_less_than' on line 128, col 87
        if _v is not None: write(_filter(_v, rawExpr='$stock_less_than')) # from line 128, col 87.
        write('''" /><br />
...
<input class="textbox" type="text" name="stock_more_than" id="stock_more_than" value="''')
        _v = VFFSL(SL,"stock_more_than",True) # '$stock_more_than' on line 131, col 87
        if _v is not None: write(_filter(_v, rawExpr='$stock_more_than')) # from line 131, col 87.
        write('''" /><br />
...
<input class="textbox" type="text" name="sold_more_than" id="sold_more_than"  value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$sold_more_than')) # from line 134, col 86.
        write('''" /><br />
...
<label class=\'textbox\' for=\'begin_date\'>This item sold After:</label><input type=\'text\' class=\'textbox\' name=\'begin_date\' id=\'begin_date\' value=\'''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='${begin_date}')) # from line 136, col 146.
        write("""'/><br />
<label class='textbox' for='end_date'>This item sold Before</label><input type='text' class='textbox' name='end_date' id='end_date' value='""")
        ...
        if _v is not None: write(_filter(_v, rawExpr='${end_date}')) # from line 137, col 140.
        write("""'/><br />
""")
        # 
        # <script type='text/javascript'>
...
<input class="textbox" type="text" id="tag" name="tag" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$tag')) # from line 154, col 63.
        write('''" /><br />
</div>
...
''')
        for k in VFFSL(SL,"kinds",True): # generated from line 159, col 1
            ...
            if _v is not None: write(_filter(_v, rawExpr='$k.id')) # from line 160, col 16.
            write("""' 
""")
            if "%s" %(VFFSL(SL,"k.id",True))==VFFSL(SL,"kind",True): # generated from line 161, col 1
                write('''selected="true" 
''')
            write('''>''')
            _v = VFFSL(SL,"k.kindName",True) # '$k.kindName' on line 164, col 2
            if _v is not None: write(_filter(_v, rawExpr='$k.kindName')) # from line 164, col 2.
            write('''</option>
''')
        write('''</select><br />
...
<h1> ''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$table_is_form')) # from line 172, col 6.
        write(''' </h1>
''')
        _v = VFFSL(SL,"onclickhandler",True) # '$onclickhandler' on line 173, col 1
        if _v is not None: write(_filter(_v, rawExpr='$onclickhandler')) # from line 173, col 1.
        write('''
<h1> ''')
        _v = VFFSL(SL,"myname",True) # '$myname' on line 174, col 6
        if _v is not None: write(_filter(_v, rawExpr='$myname')) # from line 174, col 6.
        write(''' </h1>
''')
        if VFFSL(SL,"table_is_form",True) == True: # generated from line 175, col 1
            write('''<form action="/titlelist" method="get" >
''')
        write('''<table class="sortable" id="results_table" >
<thead>
  <tr>
''')
...
''')
        for t in VFFSL(SL,"titles",True): # generated from line 199, col 1
            write('''  <tr>
''')
            if VFFSL(SL,"table_is_form",True) == True: # generated from line 201, col 1
                write('''    <td><input type="checkbox" name="titles" value="''')
                _v = VFFSL(SL,"t.id",True) # '$t.id' on line 202, col 53
                if _v is not None: write(_filter(_v, rawExpr='$t.id')) # from line 202, col 53.
...
''')
            write('''    <td>''')
            if VFN(VFFSL(SL,"t",True),"safe",False)('booktitle') : # generated from line 209, col 9
    ...
    <td>''')
            ...
            write('''</td>
    <td>''')
            if VFN(VFFSL(SL,"t",True),"copies_in_status",False)("STOCK") : # generated from line 212, col 9
            ...
            write('''</td>
    <td>''')
            if VFN(VFFSL(SL,"t",True),"copies_in_status",False)("SOLD") : # generated from line 213, col 9
            ...
            write('''</td>
    <td>''')
            if VFN(VFFSL(SL,"t",True),"distributors_as_string",False)() : # generated from line 214, col 9
            ...
            write('''</td>
    <td>''')
            if VFN(VFFSL(SL,"t",True),"safe",False)('publisher') : # generated from line 215, col 9
            ...
            write('''</td>
    <td>''')
            if VFFSL(SL,"t.first_book_inventoried.inventoried_when",True) : # generated from line 216, col 9
            ...
            write('''</td>
    <td>''')
            if VFFSL(SL,"t.last_book_inventoried.inventoried_when",True) : # generated from line 217, col 9
            ...
            write('''</td>
    <td>''')
            if VFFSL(SL,"t.first_book_sold.sold_when",True) : # generated from line 218, col 9
            ...
            write('''</td>
    <td>''')
            if VFFSL(SL,"t.last_book_sold.sold_when",True) : # generated from line 219, col 9
