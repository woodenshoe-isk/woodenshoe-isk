...
__CHEETAH_genTime__ = 1316642131.949351
...
''')
    ...
    def body(self, **KWS):
        ...
        write(u'''<h1>Your cart currently contains:</h1>
<a class="close" href="javascript:window.close()">X</a>
<form action="/addtocart">
<table>
''')
        for q in VFFSL(SL,"quantities",True): # generated from line 13, col 1
            write(u'''<tr><td><input type="text" width="3" name="select_x_like_''')
            _v = VFN(VFFSL(SL,"q",True)[0],"id",True) # u'${q[0].id}' on line 14, col 58
            if _v is not None: write(_filter(_v, rawExpr=u'${q[0].id}')) # from line 14, col 58.
            write(u'''" value="''')
            _v = VFFSL(SL,"q",True)[1] # u'${q[1]}' on line 14, col 77
            if _v is not None: write(_filter(_v, rawExpr=u'${q[1]}')) # from line 14, col 77.
            write(u'''" /></td><td>''')
            _v = VFN(VFFSL(SL,"q",True)[0],"title.booktitle",True) # u'${q[0].title.booktitle}' on line 14, col 97
            if _v is not None: write(_filter(_v, rawExpr=u'${q[0].title.booktitle}')) # from line 14, col 97.
            write(u'''</td></tr>
''')
        write(u'''</table>
