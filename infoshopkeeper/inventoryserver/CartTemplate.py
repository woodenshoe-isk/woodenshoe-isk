...
''')
    ...
    def body(self, **KWS):
        ...
        write("""    <h1>Remove Items from Inventory</h1>
    <div id = 'cart_panel'>
""")
        ...
        for dep in VFFSL(SL,"departments",True): # generated from line 370, col 9
            ...
            if _v is not None: write(_filter(_v, rawExpr="$dep['name']")) # from line 371, col 25.
            write("""' class='department_button' value=""")
            _v = VFFSL(SL,"dep",True) # '$dep' on line 371, col 71
            if _v is not None: write(_filter(_v, rawExpr='$dep')) # from line 371, col 71.
            write('''>''')
            _v = VFFSL(SL,"dep",True)['label'] # "$dep['label']" on line 371, col 76
            if _v is not None: write(_filter(_v, rawExpr="$dep['label']")) # from line 371, col 76.
            write("""</button>
            <div id='my-form-""")
            _v = VFFSL(SL,"dep",True)['name'] # "$dep['name']" on line 372, col 30
            if _v is not None: write(_filter(_v, rawExpr="$dep['name']")) # from line 372, col 30.
            write("""' class='my-forms' title='Enter ISBN, Author/Title or Price' data-name=""")
            _v = VFFSL(SL,"dep",True)['name'] # "$dep['name']" on line 372, col 113
            if _v is not None: write(_filter(_v, rawExpr="$dep['name']")) # from line 372, col 113.
            write(''' data-label=''')
            _v = VFFSL(SL,"dep",True)['label'] # "$dep['label']" on line 372, col 137
            if _v is not None: write(_filter(_v, rawExpr="$dep['label']")) # from line 372, col 137.
            write(''' data-is_inventoried_item=''')
            _v = VFFSL(SL,"dep",True)['isInventoriedItem'] # "$dep['isInventoriedItem']" on line 372, col 176
            if _v is not None: write(_filter(_v, rawExpr="$dep['isInventoriedItem']")) # from line 372, col 176.
            write(''' data-is_taxable=''')
            _v = VFFSL(SL,"dep",True)['isTaxable'] # "$dep['isTaxable']" on line 372, col 218
            if _v is not None: write(_filter(_v, rawExpr="$dep['isTaxable']")) # from line 372, col 218.
            write(""">
                <form action='' method='get'>
                    <input class='isbnfield' type='text' name='isbn' />""")
            write('''                    <div class="special_order_div" style=\'display: none;\'>
...
''')
        if VFFSL(SL,"session_data",True): # generated from line 396, col 21
            if VFFSL(SL,"session_data.items",True): # generated from line 397, col 25
                for item in VFFSL(SL,"session_data.items",True): # generated from line 398, col 29
                    write('''                                <tr>
''')
                    for key in VFFSL(SL,"column_keys",True): # generated from line 400, col 37
                        write('''                                        <td>
''')
                        try: # generated from line 402, col 45
                            write('''                                                ''')
                            _v = VFFSL(SL,"item",True)[VFFSL(SL,"key",True)] # '$item[$key]' on line 403, col 49
                            if _v is not None: write(_filter(_v, rawExpr='$item[$key]')) # from line 403, col 49.
                            write('''
''')
                        ...
                        write('''                                        </td>
''')
                    write('''                                    <td><input type="button" class="remove_item" value="Drop from Cart" /></td>
                                </tr>
''')
        write('''                </tbody>
            </table>
