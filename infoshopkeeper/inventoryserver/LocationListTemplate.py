...
''')
    ...
    def body(self, **KWS):
        ...
        write(u'''<h1>Locations</h1>
<ul>
''')
        for l in VFFSL(SL,"locations",True): # generated from line 11, col 1
            write(u'''<li><a href="/admin/locationedit?id=''')
            _v = VFFSL(SL,"l.id",True) # u'$l.id' on line 12, col 37
            if _v is not None: write(_filter(_v, rawExpr=u'$l.id')) # from line 12, col 37.
            write(u'''">''')
            _v = VFFSL(SL,"l.locationName",True) # u'$l.locationName' on line 12, col 44
            if _v is not None: write(_filter(_v, rawExpr=u'$l.locationName')) # from line 12, col 44.
            write(u'''</></li>
''')
        write(u'''</ul>
