...
''')
        for l in VFFSL(SL,"locations",True): # generated from line 14, col 1
            ...
            if _v is not None: write(_filter(_v, rawExpr='$l.id')) # from line 15, col 37.
            write('''">''')
            _v = VFFSL(SL,"l.locationName",True) # '$l.locationName' on line 15, col 44
            if _v is not None: write(_filter(_v, rawExpr='$l.locationName')) # from line 15, col 44.
            write('''</></li>
''')
        write('''</ul>
