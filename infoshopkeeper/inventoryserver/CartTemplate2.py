...
""")
        ...
        for dep in VFFSL(SL,"departments",True): # generated from line 371, col 9
            ...
            if _v is not None: write(_filter(_v, rawExpr="$dep['name']")) # from line 372, col 25.
            write("""' class='department_button' value=""")
            _v = VFFSL(SL,"dep",True) # '$dep' on line 372, col 71
            if _v is not None: write(_filter(_v, rawExpr='$dep')) # from line 372, col 71.
            write('''>''')
            _v = VFFSL(SL,"dep",True)['label'] # "$dep['label']" on line 372, col 76
            if _v is not None: write(_filter(_v, rawExpr="$dep['label']")) # from line 372, col 76.
            write("""</button>
            <div id='my-form-""")
            _v = VFFSL(SL,"dep",True)['name'] # "$dep['name']" on line 373, col 30
            if _v is not None: write(_filter(_v, rawExpr="$dep['name']")) # from line 373, col 30.
            ...
            if _v is not None: write(_filter(_v, rawExpr="$dep['name']")) # from line 373, col 113.
            write(''' data-label=''')
            _v = VFFSL(SL,"dep",True)['label'] # "$dep['label']" on line 373, col 137
            if _v is not None: write(_filter(_v, rawExpr="$dep['label']")) # from line 373, col 137.
            write(''' data-is_inventoried_item=''')
            _v = VFFSL(SL,"dep",True)['isInventoriedItem'] # "$dep['isInventoriedItem']" on line 373, col 176
            if _v is not None: write(_filter(_v, rawExpr="$dep['isInventoriedItem']")) # from line 373, col 176.
            write(''' data-is_taxable=''')
            _v = VFFSL(SL,"dep",True)['isTaxable'] # "$dep['isTaxable']" on line 373, col 218
            if _v is not None: write(_filter(_v, rawExpr="$dep['isTaxable']")) # from line 373, col 218.
            write(""">
...
''')
        if VFFSL(SL,"session_data",True): # generated from line 397, col 21
            if VFFSL(SL,"session_data.items",True): # generated from line 398, col 25
                for item in VFFSL(SL,"session_data.items",True): # generated from line 399, col 29
                    write('''                                <tr>
''')
                    for key in VFFSL(SL,"column_keys",True): # generated from line 401, col 37
                        write('''                                        <td>
''')
                        try: # generated from line 403, col 45
                            write('''                                                ''')
                            _v = VFFSL(SL,"item",True)[VFFSL(SL,"key",True)] # '$item[$key]' on line 404, col 49
                            if _v is not None: write(_filter(_v, rawExpr='$item[$key]')) # from line 404, col 49.
                            write('''
''')
