...
__CHEETAH_genTime__ = 1510105565.9038568
...
"""
        ...
        for q in VFFSL(SL, "quantities", True):  # generated from line 12, col 1
            ...
            write("""</b></td><td><b>""")
            _v = VFN(
                VFFSL(SL, "q", True)[0], "title.booktitle", True
            )  # '${q[0].title.booktitle}' on line 13, col 35
            if _v is not None:
                write(
                    _filter(_v, rawExpr="${q[0].title.booktitle}")
                )  # from line 13, col 35.
            write(
                """</b></td></tr>
"""
...
"""
        ...
        for schedule in VFFSL(SL, "schedules", True):  # generated from line 24, col 1
            ...
            if _v is not None:
                write(_filter(_v, rawExpr="${schedule[0]}"))  # from line 25, col 9.
            write(
                """</option>
"""
            )
