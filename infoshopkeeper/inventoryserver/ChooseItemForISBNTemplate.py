...
<input class="textbox" type="text" id="title" name="title" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$title')) # from line 86, col 67.
        write('''" /><br />
...
<input class="textbox" type="text" name="author" id="author" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$author')) # from line 89, col 69.
        write('''" /><br />
...
<input class="textbox" type="text" name="category" id="category" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$category')) # from line 92, col 73.
        write('''" /><br />
...
''')
        ...
        for loc in VFFSL(SL,"locations",True): # generated from line 102, col 1
            ...
            if _v is not None: write(_filter(_v, rawExpr='$i')) # from line 103, col 12.
            write(""" value='""")
            _v = VFFSL(SL,"loc.id",True) # '$loc.id' on line 103, col 22
            if _v is not None: write(_filter(_v, rawExpr='$loc.id')) # from line 103, col 22.
            write("""' 
""")
            if "%s" %(VFFSL(SL,"loc.id",True))==VFFSL(SL,"location",True): # generated from line 104, col 1
                write('''selected="true" 
''')
            write('''>''')
            _v = VFFSL(SL,"loc.locationName",True) # '$loc.locationName' on line 107, col 2
            if _v is not None: write(_filter(_v, rawExpr='$loc.locationName')) # from line 107, col 2.
            write('''</option>
''')
            i = VFFSL(SL,"i",True)+1
        write('''</select><br />
...
<input class="textbox" type="text" name="publisher" id="publisher" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$publisher')) # from line 113, col 75.
        write('''" /><br />
...
<input class="textbox" type="text" name="distributor" id="distributor" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$distributor')) # from line 116, col 79.
        write('''" /><br />
...
<input class="textbox" type="text" name="owner" id="owner" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$owner')) # from line 119, col 67.
        write('''" /><br />
...
<input class="textbox" type="text" id="tag" name="tag" value="''')
        ...
        if _v is not None: write(_filter(_v, rawExpr='$tag')) # from line 122, col 63.
        write('''" /><br />
</div>
...
''')
        for k in VFFSL(SL,"kinds",True): # generated from line 127, col 1
            ...
            if _v is not None: write(_filter(_v, rawExpr='$k.id')) # from line 128, col 16.
            write("""' 
""")
            if "%s" %(VFFSL(SL,"k.id",True))==VFFSL(SL,"kind",True): # generated from line 129, col 1
                write('''selected="true" 
''')
            write('''>''')
            _v = VFFSL(SL,"k.kindName",True) # '$k.kindName' on line 132, col 2
            if _v is not None: write(_filter(_v, rawExpr='$k.kindName')) # from line 132, col 2.
            write('''</option>
''')
        write('''</select><br />
...
''')
                if VFFSL(SL,"t.images",True): # generated from line 165, col 9
                    write("""        <img src='""")
                    _v = VFN(VFFSL(SL,"t.images",True),"retrieve_image_url",False)("small") # '$t.images.retrieve_image_url("small")' on line 166, col 19
                    if _v is not None: write(_filter(_v, rawExpr='$t.images.retrieve_image_url("small")')) # from line 166, col 19.
                    write("""'>
""")
                write('''    </td>
''')
            write('''    <td>''')
            if VFN(VFFSL(SL,"t",True),"safe",False)('booktitle') : # generated from line 170, col 9
    ...
    <td>''')
            ...
            write('''</td>
    <td>''')
            if VFN(VFFSL(SL,"t",True),"copies_in_status",False)("STOCK") : # generated from line 174, col 9
            ...
            write('''</td>
    <td>''')
            if VFN(VFFSL(SL,"t",True),"distributors_as_string",False)() : # generated from line 175, col 9
            ...
            write('''</td>
    <td>''')
            if VFN(VFFSL(SL,"t",True),"safe",False)('publisher') : # generated from line 176, col 9
...
if not hasattr(ChooseItemForISBNTemplate, '_initCheetahAttributes'):
    templateAPIClass = getattr(ChooseItemForISBNTemplate, '_CHEETAH_templateClass', Template)
