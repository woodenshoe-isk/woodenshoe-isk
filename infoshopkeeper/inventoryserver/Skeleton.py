...
''')
    ...
    def generateMenu(self, iterable, **KWS):
        ...
        for i in VFFSL(SL,"iterable",True): # generated from line 40, col 1
            ...
            if _v is not None: write(_filter(_v, rawExpr='$i[1]')) # from line 41, col 18.
            write("""'>""")
            _v = VFFSL(SL,"i",True)[0] # '$i[0]' on line 41, col 25
            if _v is not None: write(_filter(_v, rawExpr='$i[0]')) # from line 41, col 25.
            write('''</a>
''')
            if VFFSL(SL,"i",True)[2]: # generated from line 42, col 5
                write('''    <ul>
    ''')
                _v = VFFSL(SL,"generateMenu",False)( VFFSL(SL,"i",True)[2] ) # '$generateMenu( $i[2] )' on line 44, col 5
                if _v is not None: write(_filter(_v, rawExpr='$generateMenu( $i[2] )')) # from line 44, col 5.
                write('''
    </ul>
''')
            write('''    </li>
...
''')
        ...
        _v = VFFSL(SL,"generateMenu",False)( VFN(VFFSL(SL,"menudata",True),"getMenuData",False)() ) # '$generateMenu( $menudata.getMenuData() )' on line 55, col 1
        if _v is not None: write(_filter(_v, rawExpr='$generateMenu( $menudata.getMenuData() )')) # from line 55, col 1.
        write('''
</ul>
</div>
''')
        ...
        if VFFSL(SL,"lastsearch",True): # generated from line 59, col 1
            ...
            if _v is not None: write(_filter(_v, rawExpr='$lastsearch')) # from line 60, col 10.
