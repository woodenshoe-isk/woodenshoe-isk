...
__CHEETAH_genTime__ = 1307470722.7931359
__CHEETAH_genTimestamp__ = 'Tue Jun  7 14:18:42 2011'
__CHEETAH_src__ = 'Skeleton.html'
__CHEETAH_srcLastModified__ = 'Tue Jun  7 13:58:38 2011'
...
class Skeleton(Template):
    ...
    def headtop(self, **KWS):
        ...
        ## CHEETAH: generated from #block headtop at line 24, col 1.
        trans = KWS.get("trans")
    ...
    def head(self, **KWS):
        ...
        ## CHEETAH: generated from #block head at line 5, col 1.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
        ...
        write('''<script src="/javascript/sorttable.js"></script>
...
''')
    ...
    def body(self, **KWS):
        ...
        ## CHEETAH: generated from #block body at line 43, col 1.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
...
<head>
<title>''')
        _v = VFFSL(SL,"pagetitle",True) # '$pagetitle' on line 4, col 8
        if _v is not None: write(_filter(_v, rawExpr='$pagetitle')) # from line 4, col 8.
        write('''</title>
''')
...
<body>
''')
        requestip = VFFSL(SL,"cherrypy.request.remote.ip",True)
        write('''<ul class="toolbar">
...
<li><a href="/locationlist">Manage Locations</a></li>
<li><a href="/reports">Get reports</a></li>
<li><a href="/transactions">Review Transactions</a></li>
</ul>
''')
        if VFFSL(SL,"lastsearch",True): # generated from line 39, col 1
            write('''<a href="''')
            _v = VFFSL(SL,"lastsearch",True) # '$lastsearch' on line 40, col 10
            if _v is not None: write(_filter(_v, rawExpr='$lastsearch')) # from line 40, col 10.
