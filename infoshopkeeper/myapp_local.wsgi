...
application = ErrorMiddleware(cherrypy.Application(root, script_name=None, config=cherrypy_local_config_file), debug=True, show_exceptions_in_wsgi_errors=True)
